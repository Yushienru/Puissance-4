$.fn.power = function(nb_y, nb_x, jone, jtwo, color_one, color_two) {
    ...
    function init() {
        ...
        var replay = $("<button>Rejoué</button>").addClass("replay");
    ...
    function win() {
        currentPlayer = (status) ? jone : jtwo;
        var gif = "<img src='img/gif.gif' alt='gif'>";
        $("body").prepend("<section class='alert'><p>" + currentPlayer +  " Tu sais pas jouer Jack... t'es mauvais !<br>" + gif + "</p></section>");
...
$(function() {
    $("window").power(7, 7, "LOPEZ Jo", "LOPEZ David", "#27808e", "#f14e51");
});